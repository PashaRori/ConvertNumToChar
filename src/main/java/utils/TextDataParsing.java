...
import static utils.ExcelOpen.getArrayWithValues;
...
public class TextDataParsing {
    ...
    private static String[] getArrayZeroToTen(String languageConvert) {
        ...
        arraycopy(getArrayWithValues(languageConvert), 0, arrayFromZeroToTen, 0, 10);
    ...
    private static String[] getArrayZeroToTwenty(String languageConvert) {
        ...
        arraycopy(getArrayWithValues(languageConvert), 0, arrayFromZeroToTwenty, 0, 20);
    ...
    private static String[] getArrayTwentyToNinety(String languageConvert) {
        ...
        arraycopy(getArrayWithValues(languageConvert), 20, arrayFromTwentyToNinety, 0, 8);
    ...
    public static String[] getArrayOneHundredToOneThousand(String languageConvert) {
        ...
        arraycopy(getArrayWithValues(languageConvert), 28, arrayFromOneHundredToNineHundred, 0, 9);
    ...
    public static String[] getArrayOneThousandToMaximumAvailableNumber(String languageConvert) {
        final  String[] arrayFromExcelFile = getArrayWithValues(languageConvert);
