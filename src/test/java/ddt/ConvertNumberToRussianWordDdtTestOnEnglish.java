...
public class ConvertNumberToRussianWordDdtTestOnEnglish {

    private final static Logger logger = Logger.getLogger(ConvertNumberToRussianWordDdtTestOnEnglish.class);
    ...
    public void compareNumberConvertedToWordsAndWords(String numberConvertedToWords, String referenceWords) {
        ConvertNumberToEnglishWord convertNumberToEnglishWord = new ConvertNumberToEnglishWord(numberConvertedToWords, "Rus");
        String convertedValueOfNumberToWords = convertNumberToEnglishWord.createFinalEnglishWord();
